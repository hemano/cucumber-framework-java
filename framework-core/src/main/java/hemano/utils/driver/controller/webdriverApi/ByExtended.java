package hemano.utils.driver.controller.webdriverApi;
...
/**
 * It extends the capabilities of CSS Selector by using SizzleCss
 *
 */
public abstract class ByExtended extends By {
    ...
    public static class ByCssSelectorExtended extends ByCssSelector {
        ...
        private WebDriver getDriver() {
            WebDriverWebController controller = ((WebDriverWebController) SessionContextManager.getController());
